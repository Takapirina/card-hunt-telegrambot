            ...
            for carta in wishList["carte"]:
                ...
                while tentativi < max_tentativi:
                    try:
                        ...
                        tentativi += 1
                        print(f"Errore durante il tentativo di aggiornamento per {carta['nome_personalizzato']} (Tentativo {tentativi}): {e}")
                        if tentativi >= max_tentativi:
                            print(f"Massimo numero di tentativi raggiunto per {carta['nome_personalizzato']}")
                ...
                if data:
                    ...
                    print(f"Errore nell'aggiornamento dei dati per {carta['nome_personalizzato']}")
